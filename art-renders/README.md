...
- `visual/final/`：152 件已通过规格与技术 QA 的视觉成品
- `visual/review/`：全量、分类与 48px 图标联系表
- `audio/work/`：音乐与音效工程中间产物
- `audio/final/`：23 个与 Godot 运行时清单对齐的音频成品
...
- 视觉：152/152；建筑 24、外挂 14、机柜 26、地图 23、特效 9、角色 5、客户徽章 4、UI 41、商店 6。
- 音频：23/23；3 首原创循环音乐、20 个原创交互/玩法/环境音效。
- 视觉自动 QA：精确尺寸、PNG 模式、透明四角、单文件不超过 1.5MB，152/152 通过。
- 音频自动 QA：48kHz、双声道、音乐 Vorbis 循环边界、音效 24-bit PCM，23/23 通过。
- Godot 导入 dry-run：视觉 152/152、音频 23/23，零缺失。
