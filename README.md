...
竖屏界面在 Godot 中使用 804×1748 设备无关设计画布；桌面预览与自动截图固定为 iPhone 17 Pro Max 物理分辨率 1320×2868 的一半（660×1434），使用 `aspect=keep`。交互控件遵循至少 44pt 的触控热区，并为 Dynamic Island 与 Home Indicator 预留安全区。
